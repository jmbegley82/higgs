...
TOOL_NAME = Blocktest DictionaryTest PthreadTest GfxTest TacoIsland \
	    AsyncDemo VBODemo GTest1 GTest2
...
GTest1_C_FILES = GTest1/main.c
GTest1_CFLAGS = -I/usr/local/include -IGameCommon/ ${JMCFLAGS}
GTest1_CPPFLAGS =
GTest1_LDFLAGS = -L/usr/local/lib -lGL -lGLU -lglut -lGLEW -lIL -lILU ${JMLDFLAGS}
GTest1_SUBPROJECTS = GameCommon

GTest2_C_FILES = GTest2/Glue.c GTest2/main.c
GTest2_CFLAGS = -I/usr/local/include -IGameCommon/ ${JMCFLAGS}
GTest2_CPPFLAGS =
GTest2_LDFLAGS = -L/usr/local/lib -lGL -lGLU -lglut -lGLEW -lIL -lILU ${JMLDFLAGS}
GTest2_SUBPROJECTS = GameCommon
